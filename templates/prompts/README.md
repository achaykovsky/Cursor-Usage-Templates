...
**Validated:** 2026-07-03 (analysis pass)

**Tests:** `440 passed` — `poetry run pytest templates/hooks/tests templates/commands/tests -q`

Paste prompts from this folder when routing is unclear. Open [USAGE.md](../USAGE.md) for the navigation hub.

**CLI alternatives:**

- `templates/commands/route-*.ps1`
- `query-cursor-logs.ps1`

Backed by `routing.py`, `cursor_activity.py`.
...
**Deliverables** ([plan-ai-infrastructure.md](plan-ai-infrastructure.md)):

- `ai-runtime/`
- Skill folders: `ai-infra-workflows/`, `eval-workflows/`, `rag-workflows/`, `langchain-workflows/`
- 5 AI subagents
- AI validation hooks
- RAG + prompt eval tracks
...
**Plan status:** core table **done**; optional `audit-log-patterns` stop hook still **open**.
...
**Tests:** `test_cursor_activity.py` (10 cases). **Hooks:** `log-cursor-activity.ps1` / `.sh` wired via `Get-CursorActivityScript`.

**Plan status:** steps 1–5 and prompt redaction **[x] Done**; step 6 (optional stop summary) **[ ]**.
